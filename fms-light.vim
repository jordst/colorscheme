...
hi Search guifg=HotPink guibg=NONE gui=underline ctermfg=205 ctermbg=232 cterm=underline
hi IncSearch guibg=#f0fff0 guifg=cyan ctermbg=194 ctermfg=51

hi TabLine guibg=#f0fff0 gui=NONE
hi TabLineSel guibg=#b4eeb4 guifg=Black gui=Bold
hi TabLineFill guibg=#f0fff0 guifg=#f0fff0 gui=NONE
...
hi Statement guifg=#a04bf0  gui=NONE cterm=NONE ctermfg=235
